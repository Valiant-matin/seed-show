...
<footer class="footer <? if (!in_array($APPLICATION->GetCurDir(), ['/', '/delivery/', '/about/', '/catalog/'])) : ?>mt-section<? endif; ?>">
    <div class="footer__inner">
        <div class="footer__col footer__col_left">
            <div class="footer__logo">
                <!--FIXME: вставить свг--><img src="<?= SITE_TEMPLATE_PATH ?>/images/logo-y.svg" alt="" />
            </div>
            <div class="footer__col">
                <p class="footer__text">© 2023 "Big Grain" Все права защищены</p><a class="footer__politic" href="/upload/document/PrivacyPolicyStatement.docx">Политика конфеденциальности</a>
                <p class="footer__copirait">Сайт разарботан: <a href="https://t.me/Knyaz_36" target="_blank">
    ...
    <div class="footer-bottom">
        <div class="footer-bottom__inner">
            <p class="footer-bottom__text">Оставьте заявку и наш менеджер перезвонит вам</p>
            <div class="button-footer">
                <button class="btn btn_yellow modal-on" name="Оставить заявку">Оставить заявку</button>
            </div>
        </div>
    </div>
</footer>
